...
print("win rate of [ holecard=%s ] is %f" % (list(map(str, holecard)), prediction))
...
print("win rate of [ holecard=%s, communitycard=%s ] is %f" % (list(map(str, holecard)), list(map(str, communitycard)), prediction))
